...
Since our response variable follows poisson distribution, we will use glm with poisson distribution to fit the model.
...
BIC is implemented to found the best fitting model.
