...
household$Household_Type <- ifelse(household$Household_Type == "Two or More Nonrelated Persons/Members", "two or more", household$Household_Type)     # change the long type name "Two or More Nonrelated Persons/Members"
```
...
hist(household$Number_Members, freq = FALSE, xlab = "Data", main = "Histogram of Number of Family members")
